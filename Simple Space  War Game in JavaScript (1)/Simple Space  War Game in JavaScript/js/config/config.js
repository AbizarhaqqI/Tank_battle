...
(() => {
  ...
  const bullet = (width = 1000, height = 1000) => {
    return {
      w: width,
      h: height,
      x: 0,
  ...
  config.game = {
    ...
    appendEnemyCooldown: [12 * fps, 15 * fps],
  ...
  config.playerBullet = (() => {
    let o = bullet(100, 80); // Increase player bullet size
    o.img = "playerBullet";
  ...
  config.enemyBullet = (() => {
    let o = bullet(100, 200); // Increase enemy bullet size
    o.speed = -o.speed;
    o.img = "enemyBullet";
  ...
  config.images = (() => {
    ...
    return Object.assign(
      ...
      batchAdd(path + "/star/", "star_12", "gif"),
